# 国科大计算机网络复习（2020 秋季学期）（2）

> 更新：2020 年 12 月 25 日 考完试了。#中国科学院大学# #计算机网络期末考试# #2020 年秋季学期#
>
> 试卷考试内容如下：
>
> - 最小生成树
> - 距离向量算法、下一跳更新，一个网络图，根据 B 更新 A、C 两个节点
> - Trie：查找步骤、时间复杂度和空间复杂度
> - 画图题：加、乘，图形状、周期。
> - 9、BBR 测量链路瓶颈这个图背下来，图上的坐标点表示什么？
> - CDN 和 Google 的 ECDN、ECDN 为什么好。anyagning...缓解
> - 概念：链路带宽、可用带宽、如何测量瓶颈带宽和可用带宽？
> - 7、 数据中心网络，数据级流和流量级流的优劣势
> - 非对称秘钥加密的原理、与对称秘钥加密相比的优缺点。
> - 区块链的应用场景，现有问题。
>
> PS：还命中了两个原题，虽然答得并不是非常好（复习时间太短了，还贪玩~）。按照我的这三篇博客提到的知识点重点进行复习，应该可以保证取得一个非常好的成绩。
>
> - 🥈[2020.12.24 #计算机网络# 国科大计算机网络复习（2020 秋季学期）（3）](https://landodo.github.io/posts/20201224-UCAS-computer-network-review)
> - 🥇[2020.12.22 #计算机网络# 国科大计算机网络复习（2020 秋季学期）（2）](https://landodo.github.io/posts/2020-UCAS-computer-network-review)
> - 🥉[2020.12.18 #计算机网络# 国科大计算机网络复习（2020 秋季学期）（1）](https://landodo.github.io/posts/20201218-UCAS-computer-network)
