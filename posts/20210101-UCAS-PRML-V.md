...
【update 2021.01.03】之前的公式可能犯了一些错误，现在进行一些更新。

- $$S_w = (X_1 - m_1)(X_1 - m_1)^T P(w_1) + (X_2 - m_2)(X_2 - m_2)^T P(w_2) + (X_3 - m_3)(X_3-m_3)^T P(w_3)$$
  - $$S_w = \sum_{i=1}^{3} P(w_i) E \{ (x_i - m_i)(x_i - m_i)^T \mid w_i \}$$
- $$S_b = (m_1 - m)(m_1 - m)^TP(w_3) + (m_2 - m)(m_2 - m)^TP(w_2) + (m_3 - m)(m_3-m)^TP(w_3)$$
  - $$S_b = \sum_{i=1}^{3} P(w_i)(m_i - m_0)(m_i - m_0)^T$$
- K-L 变换的协方差矩阵 $\sum$：
  - $$\sum = \frac{1}{N_1}[(X_1 - m_1)(X_1 - m_1)^T P(w_1)] + \frac{1}{N_2}[(X_2 - m_2)(X_2 - m_2)^T P(w_2)] + \frac{1}{N_3} [(X_3 - m_3)(X_3 - m_3)^T P(w_3)]$$
  - 留意多类样本的先验概率。

> 2020 年过去了。
>
> 今年的考试考得非常不好。下个学期开始，一定要好好学习，不辜负时光了。
>
> 2021 年的 Flag！
>
> 早起的生物钟已经养成，往后的日子里，不能有例外。
>
> 2020 年 01 月 02 日 晚 21:23
