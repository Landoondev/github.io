...
[深入理解卷积神经网络（CNN）——基础理论](https://zhuanlan.zhihu.com/p/34818964)

- CNN在图像分类问题上有什么优势？

## 8. Hard Margin SVM 的计算

线性可分支持向量机学习的最优化问题：

$$min_{w, b} \frac{1}{2} \left\Vert w \right\Vert^{2}$$

$$s.t.\ y_i(w^T \cdot x_i + b) - 1 \geq 0$$

支持向量是使得约束条件取等的点。Hard Margin SVM 的约束条件如下：
...
对于简单的问题，一个难点是如何求解不等式方程❓。

> 我滴乖乖！解了一晚上，没解出来。

![](./20210101/4.jpeg)

注意：解出一个变量一般都是 $w \geq ?$ ，这样就可以将等于，即最小的代入其他方程求出其他未知数的取值范围。
